...
# Check for OPENAI_API_KEY in environment or config file
...
# Run the Python streaming tool
python3 /opt/toolbox/SystemSecurityUtilities/selinux_chatgpt_stream.py
