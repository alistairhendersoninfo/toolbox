#!/usr/bin/env bash
#MN Apply Blue Steel Theme
#MD Applies blue steel colour theme to dialog
...
echo "Blue Steel theme applied."

TIMESTAMP=$(date '+%Y-%m-%d %H:%M:%S')
db_write "INSERT INTO installs (software_name, task_group, task_name, status, updated_at) VALUES ('ToolboxColours', 'Theme Change', 'Blue Steel Theme', 'completed', '$TIMESTAMP');"
