#!/usr/bin/env bash
#MN Apply Magenta Glow Theme
#MD Applies magenta glow colour theme to dialog
...
echo "Magenta Glow theme applied."

TIMESTAMP=$(date '+%Y-%m-%d %H:%M:%S')
db_write "INSERT INTO installs (software_name, task_group, task_name, status, updated_at) VALUES ('ToolboxColours', 'Theme Change', 'Magenta Glow Theme', 'completed', '$TIMESTAMP');"
