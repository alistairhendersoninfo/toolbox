#!/usr/bin/env bash
#MN Apply Dark Theme
#MD Applies dark colour theme to dialog
...
db_write "INSERT INTO installs (software_name, task_group, task_name, status, updated_at) VALUES ('ToolboxColours', 'Theme Change', 'Dark Theme', 'completed', '$TIMESTAMP');"
